...
func testReadFileFromGit(t *testing.T) {
	os.Setenv("JEC_CONF_SOURCE_TYPE", "git")
	os.Setenv("JEC_CONF_GIT_URL", "utl")
	os.Setenv("JEC_CONF_GIT_PRIVATE_KEY_FILEPATH", "/test_id_rsa")
	os.Setenv("JEC_CONF_GIT_FILEPATH", "jec/testConf.json")
	os.Setenv("JEC_CONF_GIT_PASSPHRASE", "pass")
...
func testReadFileFromLocalDefaultPath(t *testing.T) {
	os.Setenv("JEC_CONF_SOURCE_TYPE", "local")
...
func testReadFileFromLocalCustomPath(t *testing.T) {
	os.Setenv("JEC_CONF_SOURCE_TYPE", "local")
	os.Setenv("JEC_CONF_LOCAL_FILEPATH", testLocalConfFilePath)
...
func TestReadFileFromUnknownSource(t *testing.T) {
	os.Setenv("JEC_CONF_SOURCE_TYPE", "dummy")
